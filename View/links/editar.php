            ...
            <div class="col-4 offset-4">
                <form action="../../Controller/update.php" method='POST'>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name='title' placeholder="Titulo" aria-label="Username" value=<?= $rst['title'] ?> required>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        </div>
                        <input type="url" class="form-control" name='url' placeholder="Direccion Web" aria-label="Username" value=<?= $rst['url'] ?> required>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"><i class="fas fa-marker"></i></span>
                        </div>
                        <textarea name="description"  cols="30" rows="5" placeholder='Descripcion del Sitio'><?= $rst['description'] ?>
                        </textarea>
                    </div>
